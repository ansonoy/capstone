  ...
  return (
    <main className="">
      <div className="h-[100rem] flex flex-col">
        ...
        <div className=" h-full bg-gradient-to-b from-stone-700 to-black text-gray-50 text-opacity-90 z-20">
          <motion.div
            className="pt-12 w-full flex justify-center flex-col items-start px-8 pb-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          >
            <p className="text-4xl pb-8 font-bold">What is the Barrel Club?</p>
